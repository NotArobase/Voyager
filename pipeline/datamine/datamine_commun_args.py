...
class DatamineCommonArgs(Stage[CommonArgsResult, MainConfig]):
    dataset_dir_name = 'DatamineCommunRoles'  # Dossier où seront stockés les résultats
    roles_dir_name = 'StructuralModels'  # Dossier contenant les fichiers YAML
    ...
    def report_results(self, results: ResultMap[CommonArgsResult]) -> None:
        ...
        # Afficher un aperçu des arguments communs
    ...
    def run(self, _: Optional[ResultMap] = None) -> CommonArgsResult:
        ...
        # Lecture et extraction des arguments depuis les fichiers YAML
    ...
    def generate_top_arguments_chart(self, common_args_per_module):
        ...
        # Calculer l'utilisation des arguments
